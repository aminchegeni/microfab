...
import ir.co.isc.spbp.blockchain.fabino.it.Microfab;
import ir.co.isc.spbp.blockchain.fabino.it.builder.CcBuilder;
import ir.co.isc.spbp.blockchain.fabino.it.builder.CcaasBuilder;
...
import static ir.co.isc.spbp.blockchain.fabino.it.Microfab.Chaincode.Type.CCAAS;
import static ir.co.isc.spbp.blockchain.fabino.it.utils.Util.toUnchecked;
...
public class Config {
    ...
    public static class Channel {
         ...
         * instance from a {@link ir.co.isc.spbp.blockchain.fabino.it.Microfab.Channel} annotation.
         *
         * @param channel the {@link ir.co.isc.spbp.blockchain.fabino.it.Microfab.Channel} annotation
    ...
    public static class Tls {
         ...
         * instance from a {@link ir.co.isc.spbp.blockchain.fabino.it.Microfab.Tls} annotation.
         *
         * @param tls the {@link ir.co.isc.spbp.blockchain.fabino.it.Microfab.Tls} annotation
         *            whose values should populate this object
     ...
     * {@link ir.co.isc.spbp.blockchain.fabino.it.Microfab.Chaincode} annotation,
    ...
    public static class Chaincode {
         ...
         *   <li>Build the chaincode inside a {@link ir.co.isc.spbp.blockchain.fabino.it.MicrofabContainer}

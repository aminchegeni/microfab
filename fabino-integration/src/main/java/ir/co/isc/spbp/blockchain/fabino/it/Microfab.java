...
public @interface Microfab {
     ...
     *   <li>{@link #type()} → {@link Type#CCAAS}</li>
     * </ul>
     *
     * <p>
    ...
    @interface Chaincode {
         ...
         * </ul>
         * Implementation uses a dynamic {@link Proxy} to simulate
         ...
         * <ul>
         *   <li>{@link Type#CCAAS} → Chaincode-as-a-Service (runs in an external process).</li>
         *   <li>{@link Type#JAVA} → In-process Java chaincode (embedded in the peer runtime).</li>
         * </ul>
         *
         * @return the chaincode type (default: {@link Type#CCAAS})
         */
        Type type() default Type.CCAAS;
